...
// orangeVeg.forEach(o => console.log(o.name))
...
// let readableMessages = messagesFromDad.map(m => m.toLowerCase())

// readableMessages.forEach(r => console.log(r))
